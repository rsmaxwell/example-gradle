...
PROJECT="example-gradle"
GROUPID="com.rsmaxwell.example"
ARTIFACTID="${PROJECT}_${FAMILY}_${ARCHITECTURE}"
PACKAGING="zip"
ZIPFILE="${ARTIFACTID}_${VERSION}.${PACKAGING}"
REPOSITORY_BASE_URL="https://pluto.rsmaxwell.co.uk/archiva/repository"
REPOSITORY_URL="${REPOSITORY_BASE_URL}/${REPOSITORY}"
...
tags='$FAMILY,$ARCHITECTURE,$PROJECT,$GROUPID,$ARTIFACTID,$PACKAGING,$REPOSITORY_BASE_URL,$REPOSITORY_URL,$REPOSITORY,$REPOSITORYID,$VERSION,$BUILD_ID,$TIMESTAMP,$GIT_COMMIT,$GIT_BRANCH,$GIT_URL'
